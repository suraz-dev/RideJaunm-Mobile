/**
 * ============================================================================
 * ROUTE OVERLAYS, MARKERS & MAP CONTROLS DOMAIN (R8 / ADR-001)
 * ============================================================================
 *
 * WHY THIS EXISTS:
 ...
 * 3. All screen points represent synthetic fixture traces (not live GPS/SDK points).
 */
...
export type MarkerKind = 'origin' | 'destination' | 'waypoint' | 'hazard';
